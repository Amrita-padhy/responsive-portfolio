          ...
          <section className="min-h-screen">
            <div className={darkMode ? "dark" : ""}>
              <nav className="py-10 mb-12 flex justify-between md:px-20 lg:px-40 ">
                <h1 className="text-3xl bold dark:text-white">PORTFOLIO</h1>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl py-2 font-normal text-gray-900 md:text-3xl dark:text-white">
                Front-End Developer
              </h3>
              <p className="text-md py-5 leading-8 text-gray-800 max-w-xl mx-auto md:text-xl dark:text-gray-200">
                ...
                websites. Add your essential web developer job responsibilities
                to our web developer job description sample to create a custom
